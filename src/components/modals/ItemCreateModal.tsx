...
const ItemCreateModal = ({
    ...
    const initialButtonGroup = (
        <>
            <ButtonWithLoader variant="secondary" onClick={handleExit}>
                Exit
            </ButtonWithLoader>

            <ButtonWithLoader variant="primary" onClick={handleCreate}>
                Create
            </ButtonWithLoader>
        </>
    );
    ...
    return (
        <div className="Modal Modal--Stackbox">
            ...
            <div className="Modal__InputContainer">
                <Textarea
                    className="item-create-modal__input item-create-modal__input--content"
                    data-autofocus
                    label="Content"
                ...
                <div className="Modal__SubInputFlexbox">
                    ...
                    {(isFocusedOnTitleInput || isFocusedOnContentInput) && (
                        <p>
                            <KbdMod /> <kbd>S</kbd> Create and close
                        </p>
                    )}
                </div>
            </div>
            ...
            <div className="Modal__BtnContainer Modal__BtnContainer--FlexEnd">
                {isConfirmingExit ? confirmExitButtonGroup : initialButtonGroup}
            </div>
        </div>
    );
};
