...
export default function ProfileFaviconCookies() {
    const { isFaviconEnabled, setIsFaviconEnabled } = useContext(
        UserLocalSettingsContext
    );

    return (
        <section className="Profile">
            <h3 className="Profile__Title">Favicons and third-party cookies</h3>
            ...
            <div>
                ...
                <p>
                    These two matters are unforunately not separable at the
                    current time. Cookies are a complicated matter, but you
            ...
            <Checkbox
                ...
                onChange={(event) =>
                    setIsFaviconEnabled(event.currentTarget.checked)
                }
